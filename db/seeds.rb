...
agent = User.where(email: 'suporte@safetysystemtechnology.com').first_or_create({ email: 'suporte@safetysystemtechnology.com', password: 'testeteste', password_confirmation: 'testeteste' })
agent.agent = true
agent.save!

customer = User.where(email: 'cliente@safetysystemtechnology.com').first_or_create({ email: 'cliente@safetysystemtechnology.com', password: 'testeteste', password_confirmation: 'testeteste' })
customer.save!
